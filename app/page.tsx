...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <section className="text-center pt-16 sm:pt-20 pb-12 sm:pb-16">
        ...
        <section className="pb-16 sm:pb-20">
          <Card className="p-4 sm:p-6 md:p-8 max-w-4xl mx-auto bg-gradient-to-br from-slate-800/80 to-slate-900/80">
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <Card className="p-4 border-purple-500/20 sm:col-span-2 md:col-span-1">
                <div className="flex items-center gap-2 mb-3">
        ...
        <section id="how-it-works" className="pb-16 sm:pb-20 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { step: "2", icon: CheckCircle, title: "Submit Proof", desc: "Participants complete the quest and submit proof directly on the quest page — text, a link, or an image." },
        ...
        <section className="pb-16 sm:pb-20 text-center">
          <Card className="p-8 sm:p-12 bg-gradient-to-br from-blue-500/10 to-purple-500/10 border-blue-500/20">
            <h2 className="text-3xl font-bold text-white mb-4">Ready to Start?</h2>
            <p className="text-slate-400 mb-8 max-w-lg mx-auto">Sign in to create quests or start earning USDC today.</p>
            {isAuthenticated ? (
              <Link href="/dashboard">
                <Button size="lg">Launch App <ArrowRight className="w-5 h-5 ml-2" /></Button>
              </Link>
